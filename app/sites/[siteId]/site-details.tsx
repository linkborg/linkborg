        ...
        <>
            ...
            <main className="flex-1 items-start p-4 sm:px-6 sm:py-0 md:gap-8 lg:grid-cols-3 xl:grid-cols-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 items-center gap-4 text-center">
                    <Link key={`app-key-${initData?.id}-chat`} target={"_blank"} href={`https://${initData?.id}.${process.env.NEXT_PUBLIC_SITE_DOMAIN}`}>
                    ...
                    <Link key={`app-key-${initData?.id}-api`} target={"_blank"} href={`https://${initData?.id}.${process.env.NEXT_PUBLIC_SITE_DOMAIN}/swagger`}>
