    ...
    return (
        <>
            <div className="flex items-center justify-between">
                <h1 className="text-lg font-semibold md:text-2xl">Index Details</h1>
            ...
            <main className="flex-1 items-start p-4 sm:px-6 sm:py-0 md:gap-8 lg:grid-cols-3 xl:grid-cols-3">
                            ...
                            <CardTitle className="group flex items-center gap-2 text-lg">
                                ...
                                >
                                    <Copy className="h-3 w-3"
                                              onClick={() => copyTextToClipboard(initData?.remoteId || "")}/>
                                    <span className="sr-only">Copy Index ID</span>
                                </Button>
                            </CardTitle>
                        ...
                        <div className="grid gap-3">
                            <ul className="grid gap-3">
                                ...
                                <li className="flex items-center justify-between">
                                    ...
                                    <span>{initData?.dimensions}</span>
                                </li>
                                <li className="flex items-center justify-between">
                                    <span className="text-muted-foreground">Metric</span>
                                    <span>{initData?.metric}</span>
                                </li>
                            </ul>
                        </div>
                    </CardContent>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 items-center gap-4 text-center">
                    <Link key={`app-key-${initData.id}-chat`} target={"_blank"} href={`https://${initData.remoteId}.io.vectorize.sh`}>
                    ...
                    <Link key={`app-key-${initData.id}-api`} target={"_blank"} href={`https://${initData.remoteId}.io.vectorize.sh/swagger`}>
